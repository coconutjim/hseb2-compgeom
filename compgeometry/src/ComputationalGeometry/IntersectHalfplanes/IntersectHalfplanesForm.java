 ...
 * Time: 1:07 AM
 */
public class IntersectHalfplanesForm {
    public static void main(String[] args) {
        JFrame frame = new JFrame("IntersectHalfplanes");
            ...
            protected void paintComponent(Graphics g) {
                ...
                for (Halfplane halfplane : halfplanes) {
                    ...
                    if (halfplane.rightSide) {
                        ...
                        g2.drawLine((int)(-halfplane.line.c / halfplane.line.a) - 2, -2,
                                (int)((-halfplane.line.c - halfplane.line.b * this.getHeight()) / halfplane.line.a) - 2,
                                this.getHeight() - 2);
                    } else {
                        g2.setColor(Color.LIGHT_GRAY);
                        g2.setStroke(new BasicStroke(4));
